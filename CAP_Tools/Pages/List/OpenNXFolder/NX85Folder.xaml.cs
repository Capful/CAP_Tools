...
{
    /// <summary>
    /// Interaction logic for NX8.5Folder.xaml
    /// </summary>
    public partial class NX85Folder : UserControl
    {
        public NX85Folder()
        {
            InitializeComponent();
        ...
        {
            RegistryKey driverKey = NXregistry();
            string NX10EXE = (String)driverKey.GetValue("Unigraphics V26.5");
